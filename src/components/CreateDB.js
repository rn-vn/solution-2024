...
const TaskList = [
  ...
  {id: 5, name: "Eat your meal without leaving any leftovers", path: "SDGs12logo.svg"}, 
  {id: 6, name: "Use food sharing services", path: "SDGs2logo.svg"}, 
  {id: 7, name: "Donate to a food bank", path: "SDGs2logo.svg"}, 
  {id: 8, name: "walking, biking, or public transportation instead of driving a car", path: "SDGs13logo.svg"}, 
  {id: 9, name: "Buy plastic-free products", path: "SDGs14logo.svg"},
  {id: 10, name: "Buy refillable products", path: "SDGs12logo.svg"},
  {id: 11, name: "Buy products with FSC certification", path: "SDGs15logo.svg"},
  {id: 12, name: "Buy products with MSC certification", path: "SDGs14logo.svg"},
  {id: 13, name: "Buy products with ASC certification", path: "SDGs14logo.svg"},
  {id: 14, name: "Buy organic vegetables", path: "SDGs3logo.svg"},
  {id: 15, name: "Join an event on the SDGs", path: "SDGs17logo.svg"},
  {id: 16, name: "Buy fair trade products", path: "SDGs12logo.svg"},
  {id: 17, name: "Look at the hazard map", path: "SDGs11logo.svg"},
  ...
  {id: 24, name: "Consider whether you have gender discrimination", path: "SDGs5logo.svg"},
  {id: 25, name: "Save water", path: "SDGs6logo.svg"},
  {id: 26, name: "Save electricity", path: "SDGs7logo.svg"},
  {id: 27, name: "Think about working as yourself in the future", path: "SDGs8logo.svg"},
  {id: 28, name: "Donate for areas with poor infrastructure facilities", path: "SDGs9logo.svg"},
